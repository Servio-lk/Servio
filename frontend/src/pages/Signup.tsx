  ...
  return (
    <div className="flex flex-col gap-2 md:gap-3 items-center text-center w-full">
      ...
      <p className="text-sm md:text-base text-gray-700">
        Create an account to start managing your vehicle services.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="flex justify-center w-full">
      <p className="text-xs md:text-sm text-gray-600 text-center">
        ...
        <button className="text-[#FF5D2E] hover:underline">Terms of Service</button>
        {" "}and{" "}
        <button className="text-[#FF5D2E] hover:underline">Privacy Policy</button>
      </p>
    </div>
  );
}
...
function GoogleSignupButton({ onClick }: { onClick: () => void }) {
  return (
    <Button
      onClick={onClick}
      variant="outline"
...
function FacebookSignupButton({ onClick }: { onClick: () => void }) {
  return (
    <Button
      onClick={onClick}
      variant="outline"
    ...
    <div className="w-full max-w-md px-4 sm:px-6 md:px-8">
      <div className="flex flex-col gap-2.5 md:gap-3 lg:gap-4">
        ...
        <div className="flex flex-col gap-2.5 md:gap-3 lg:gap-4">
          ...
          <FacebookSignupButton onClick={handleFacebookSignup} />
        </div>
