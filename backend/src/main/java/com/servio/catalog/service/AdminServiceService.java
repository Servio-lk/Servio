...
import com.servio.catalog.entity.ServiceCategory;
import com.servio.catalog.entity.ServiceOption;
import com.servio.catalog.entity.ServicePhoto;
import com.servio.catalog.entity.ServiceStatus;
import com.servio.catalog.repository.ServiceCategoryRepository;
...
import com.servio.admin.dto.ServiceOptionRequest;
import com.servio.admin.dto.ServicePhotoDto;
...
public class AdminServiceService {
    ...
    public AdminServiceDto convertToDto(com.servio.catalog.entity.Service service) {
    ...
    public com.servio.catalog.entity.Service getServiceById(Long id) {
        return serviceRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Service not found with id: " + id));
    }

    @Transactional
    public com.servio.catalog.entity.Service createService(ServiceRequest request) {
        ServiceCategory category = resolveCategory(request.getCategoryId());

        com.servio.catalog.entity.Service service = new com.servio.catalog.entity.Service();
        ...
        com.servio.catalog.entity.Service saved = serviceRepository.save(service);
    ...
    @Transactional
    public com.servio.catalog.entity.Service updateService(Long id, ServiceRequest request) {
        com.servio.catalog.entity.Service service = getServiceById(id);
    ...
    @Transactional
    public com.servio.catalog.entity.Service toggleServiceStatus(Long id, ServiceToggleRequest request) {
        com.servio.catalog.entity.Service service = getServiceById(id);
    ...
    @Transactional
    public com.servio.catalog.entity.Service publishService(Long id) {
        com.servio.catalog.entity.Service service = getServiceById(id);
    ...
    @Transactional
    public com.servio.catalog.entity.Service hideService(Long id) {
        com.servio.catalog.entity.Service service = getServiceById(id);
    ...
    private void syncIncludedItems(com.servio.catalog.entity.Service service, List<String> includedItems) {
    ...
    private void syncOptions(com.servio.catalog.entity.Service service, List<ServiceOptionRequest> optionRequests) {
    ...
    private void syncPhotos(com.servio.catalog.entity.Service service, List<ServicePhotoDto> photoDtos) {
    ...
    private void syncPrimaryImage(com.servio.catalog.entity.Service service) {
    ...
    private void notifyCustomersIfNeeded(com.servio.catalog.entity.Service service) {
